    ...
    <Layout>
      ...
      <Container>
          ...
          <div className='pt-6 text-lightgray mb-20'>
              <p className='py-2 wow fadeInUp' data-wow-delay='0.08s'>
              ...
              <p className='py-2 wow fadeInUp' data-wow-delay='0.16s'>
              ...
              <p className='py-2 wow fadeInUp' data-wow-delay='0.24s'>
