          ...
          <ol className="relative border-s border-gray-700">
            <li className="mb-12 ms-6">
              ...
              <p className="text-base font-normal text-gray-300">
                ...
                managing customer Service Requests (SR). The system includes a
                customizable SR catalog per client, structured ticket
            ...
            <li className=" ms-6">
              ...
              <time className="block mb-5 text-sm font-normal leading-none text-gray-400">
                University of Insubria / Freelance, Italy. 2022 - 2024
              </time>
              <p className="text-base font-normal text-gray-300">
                University tutor in 2023 for the Programming, Computer
                Architecture, and Data Science courses. <br />I conducted
                lectures for 35+ students, many of whom I continued to tutor
                privately, yielding excellent results.
              </p>
            </li>
          </ol>
        </div>
