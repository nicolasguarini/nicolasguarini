...
const externalLinkClasses = 'text-muted hover:text-white transition-colors';

const Footer = () => {
	return (
		<footer className="flex flex-col content-between container px-2 m-auto">
			<div className="flex flex-wrap justify-between border border-line rounded-lg md:p-12 sm:p-8 p-6 gap-10">
